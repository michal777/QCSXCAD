...
PageBasicSimSetup::PageBasicSimSetup(QWizard *parent, QCSXCAD *wizardsparent): QWizardPage(parent)
{
...
void PageBasicSimSetup::LoadSettings()
{
    fmin->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_fmin", "").toString());
    fmax->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_fmax", "").toString());
    combo_frequnit->setCurrentText(parent_tmp->wizard_settings->value("PageBasicSimSetup_combo_frequnit", "").toString());

    init_ftdt_param_NrTS->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_NrTS", "").toString());
    init_ftdt_param_EndCriteria->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_EndCriteria", "").toString());
    init_ftdt_param_MaxTime->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_MaxTime", "").toString());
    init_ftdt_param_OverSampling->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_OverSampling", "").toString());
    init_ftdt_param_CoordSystem->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_CoordSystem", "").toString());
    init_ftdt_param_MultiGrid->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_MultiGrid", "").toString());
    init_ftdt_param_TimeStep->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_init_ftdt_param_TimeStep", "").toString());
    init_ftdt_param_TimeStepFactor->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_TimeStepFactor", "").toString());
    init_ftdt_param_TimeStepMethod->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_TimeStepMethod", "").toString());
    init_ftdt_param_CellConstantMaterial->setText(parent_tmp->wizard_settings->value("PageBasicSimSetup_init_ftdt_param_CellConstantMaterial", "").toString());
}

void PageBasicSimSetup::SaveSettings()
{
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_fmin", fmin->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_fmax", fmax->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_combo_frequnit", combo_frequnit->currentText());

    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_NrTS", init_ftdt_param_NrTS->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_EndCriteria", init_ftdt_param_EndCriteria->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_MaxTime", init_ftdt_param_MaxTime->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_OverSampling", init_ftdt_param_OverSampling->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_CoordSystem", init_ftdt_param_CoordSystem->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_MultiGrid", init_ftdt_param_MultiGrid->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_init_ftdt_param_TimeStep", init_ftdt_param_TimeStep->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_TimeStepFactor", init_ftdt_param_TimeStepFactor->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_TimeStepMethod", init_ftdt_param_TimeStepMethod->text());
    parent_tmp->wizard_settings->setValue("PageBasicSimSetup_init_ftdt_param_CellConstantMaterial", init_ftdt_param_CellConstantMaterial->text());
}


void PageBasicSimSetup::initializePage()
{
    LoadSettings();
}
...
void PageBasicSimSetup::ConfigSimPar(void)
{
    ...
    fmin = new QLineEdit(this);
    QLabel *statictext_freqhypen = new QLabel(" - ", this);
    fmax = new QLineEdit(this);
    ...
    grid_sim_par->addWidget(fmin, 1, 1, Qt::AlignLeft);
    grid_sim_par->addWidget(statictext_freqhypen, 1, 2, Qt::AlignLeft);
    grid_sim_par->addWidget(fmax, 1, 3, Qt::AlignLeft);
